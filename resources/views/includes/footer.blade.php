...
<footer class="bg-gray-900 text-gray-300 mt-2">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
            <!-- Left Column: Logo, Description, Social Icons -->
            <div class="lg:col-span-4 flex flex-col items-start text-left">
                <!-- Logo -->
                <div class="mb-6">
